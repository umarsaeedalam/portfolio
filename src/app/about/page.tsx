...
function AboutPage() {
    return (
        <section className="flex justify-center items-center mt-12 max-[1000px]:mt-11 max-[650px]:mt-10 max-[450px]:mt-9 pb-28 max-[1000px]:pb-24 max-[650px]:pb-20 max-[450px]:pb-16">
            <div className="max-w-6xl text-xl max-[1000px]:text-19 max-[650px]:text-lg max-[450px]:text-17 px-10 max-[1000px]:px-8 max-[650px]:px-6 max-[450px]:px-5">
                <h1 className="text-accent-500 font-bold text-6xl max-[1000px]:text-5xl max-[650px]:text-4xl text-center">My Story</h1>

                <div className="tracking-wide flex flex-col gap-10 max-[1000px]:gap-8 max-[650px]:gap-6 max-[450px]:gap-5 mt-10 max-[1000px]:mt-9 max-[650px]:mt-8">
                    <p>
