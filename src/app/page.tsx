        ...
        <>
            <section className="flex justify-center items-center h-[calc(100svh-64px)] max-[1000px]:h-[calc(100svh-60px)]">
                <div className="flex flex-col gap-5">
                    ...
                    <h1 className={`${accentFont.className} text-12xl max-[1000px]:text-12xl max-[800px]:text-10xl max-[625px]:text-9xl max-[550px]:text-6xl tracking-normal leading-[115px] max-[1000px]:leading-[95px] max-[800px]:leading-[75px] max-[625px]:leading-[75px] max-[550px]:leading-[50px] text-secondary-500`}>Umar Saeed</h1>
